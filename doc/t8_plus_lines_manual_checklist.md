...
12a. Подписи одной роли от разных источников не перекрываются: у максимума и среднего вторая подпись стоит ПОД своей линией, у минимума — справа. Проверять на прогонах с близкими значениями, где линии идут почти вплотную.
