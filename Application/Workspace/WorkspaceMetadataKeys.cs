namespace JSQViewer.Application.Workspace
{
    ...
    /// (equipment model, experiment type, climate mode). These are source-specific: they must not
    /// survive a merge of several recordings into one workspace, because a merged <c>Meta</c> is
    /// workspace-global and cannot be attributed to any one of the merged sources.
    /// </summary>
